...
export default function ComponentTypography() {
  ...
  const handleFileChange = async (event) => {
    ...
    if (file) {
      ...
      try {
        ...
        const response = await axios.post('https://a58e-49-43-3-229.ngrok-free.app/transcribe', formData, {
          headers: {
  ...
  useEffect(() => {
    const fetchUploads = async () => {
      ...
      try {
        const response = await axios.post('https://a58e-49-43-3-229.ngrok-free.app/uploads', {
...
const handleDeleteUpload = async (meetingId) => {
    ...
    try {
      ...
      const response = await axios.delete('https://a58e-49-43-3-229.ngrok-free.app/delete_upload', {
